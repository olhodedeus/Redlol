...
read -p "Do you want me to install Redolol Bot? (Y/N): "
...
if [ "$REPLY" != "Y" ]; then
    ...
    rocks="luasocket luasec redis-lua lua-term serpent dkjson Lua-cURL luautf8"
    ...
    git clone -b $branch https://github.com/olhodedeus/Redlol.git
